...
public class ClienteApplicationService implements ClienteService {
	...
	public List<ClienteListResponse> buscaTodosClientes() {
		log.info("[inicial] ClienteApplicationService - buscaTodosClientes");
	...
	public ClienteDetalhadoResponse buscaClienteAtravesId(UUID idCliente) {
		log.info("[inicial] ClienteApplicationService - buscaClienteAtravesId");
	...
	public void deletaClienteAtravesId(UUID idCliente) {
		log.info("[inicial] ClienteApplicationService - deletaClienteAtravesId");
		Cliente cliente = clienteRepository.buscaClienteAtravesId(idCliente);
	...
	public void patchAlteraCliente(UUID idCliente, ClienteAlteracaoRequest clienteAlteracaoRequest) {
		log.info("[inicial] ClienteApplicationService - patchAlteraCliente");
		Cliente cliente = clienteRepository.buscaClienteAtravesId(idCliente);
